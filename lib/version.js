...
let PKG_VERSION = '';
try { PKG_VERSION = JSON.parse(fs.readFileSync(path.join(REPO_DIR, 'package.json'), 'utf8')).version || ''; } catch {}
...
function versionInfo() {
  ...
  return {
    version: PKG_VERSION,   // package.json version of the code on disk
